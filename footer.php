...
if ( is_page_template( 'page-template-blank.php' ) || is_page_template( 'shareable-page.php' ) ) :
    // Do nothing, which effectively hides the footer for these templates.
else : ?>
...
<?php endif; // ! is_page_template( 'page-template-blank.php' ) || ! is_page_template( 'shareable-page.php' ) ?>
